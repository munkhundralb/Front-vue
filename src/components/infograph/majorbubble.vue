  ...
  mounted() {
    ...
    let data = {
      ...
      children: [
        ...
        {
          name: "Завхан аймаг дахь Бизнес, мэдээллийн технологийн сургууль",
          children: [
            {
              name: "Нягтлан бодох бүртгэл",
              value: 1,
        ...
        {
          name: "Улс төр, олон улсын харилцаа, нийтийн удирдлагын сургууль",
          children: [
            {
          ...
          children: [
            ...
            },
            {
              ...
              children: [
                ...
                {
                  name: "Гадаад хэлний орчуулга (Герман)",
                  value: 1,
                },
              ],
              value: this.salbarvalue,
